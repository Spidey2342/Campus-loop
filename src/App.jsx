...
<Route path="/store/:username" element={
  <ProtectedRoute><StorefrontPage /></ProtectedRoute>
} />
<Route path="/marketplace/storefront" element={
  <ProtectedRoute><StorefrontSettingsPage /></ProtectedRoute>
} />
